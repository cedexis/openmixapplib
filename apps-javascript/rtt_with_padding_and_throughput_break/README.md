# Application: **RTT with Throughput Tie Breaker and Padding**

Choose the best provider based on HTTP RTT. If the top 2 are with x% of each other, use HTTP Throughput to break the tie.
