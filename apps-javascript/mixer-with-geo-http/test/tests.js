...
(function() {
    ...
    QUnit.test('test 1 optimum_server_chosen', function(assert) {
        test_handle_request({
            ...
            verify: function(i) {
                ...
                assert.equal(i.response.addProviderHost.callCount, 2, 'Verifying addProviderHost call count');
                ...
                assert.equal(i.response.addProviderHost.args[0][1], 'cn.bar.net', 'Verifying Provider CNAME 1');
                assert.equal(i.response.addProviderHost.args[1][0], 'foo', 'Verifying Provider Alias 2');
                assert.equal(i.response.addProviderHost.args[1][1], 'cn.foo.net', 'Verifying Provider CNAME 2');
                assert.equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    QUnit.test('optimum_server_chosen_No_KBPS', function(assert) {
        test_handle_request({
            ...
            verify: function(i) {
                ...
                assert.equal(i.response.addProviderHost.args[0][1], 'cn.foo.net', 'Verifying Provider CNAME 1');
                assert.equal(i.response.addProviderHost.args[1][0], 'bar', 'Verifying Provider Alias 2');
                assert.equal(i.response.addProviderHost.args[1][1], 'cn.bar.net', 'Verifying Provider CNAME 2');
                assert.equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
                assert.equal(i.response.setReasonCode.args[0][0], 'I,A', 'Verifying setReasonCode');
            }
        })();
    ...
    QUnit.test('test 2 geo_override_on_state', function(assert) {
        test_handle_request({
            ...
            verify: function(i) {
                ...
                assert.equal(i.response.addProviderHost.args[0][0], 'foo', 'Verifying Provider Alias 1');
                assert.equal(i.response.addProviderHost.args[0][1], 'az.foo.net', 'Verifying Provider CNAME 1');
                assert.equal(i.response.addProviderHost.args[1][0], 'baz', 'Verifying Provider Alias 2');
                assert.equal(i.response.addProviderHost.args[1][1], 'az.baz.net', 'Verifying Provider CNAME 2');
                assert.equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    QUnit.test('test 6 asn_override', function(assert) {
        test_handle_request({
            ...
            verify: function(i) {
                ...
                assert.equal(i.response.addProviderHost.args[0][1], 'cn.foo.net', 'Verifying Provider CNAME 1');
                assert.equal(i.response.addProviderHost.args[1][0], 'baz', 'Verifying Provider Alias 2');
                assert.equal(i.response.addProviderHost.args[1][1], 'cn.baz.net', 'Verifying Provider CNAME 2');
                assert.equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    QUnit.test('test 11 sonar_data_problem', function(assert) {
        test_handle_request({
            setup: function(i) {
                i.request
                    .getProbe
    ...
    QUnit.test('fallbackBehavior none avail choose highest avail', function(assert) {
        test_handle_request({
            ...
            verify: function(i) {
                ...
                assert.equal(i.response.addProviderHost.args[0][1], 'cn.baz.net', 'Verifying Provider CNAME 1');
                assert.equal(i.response.addProviderHost.args[1][0], 'bar', 'Verifying Provider Alias 2');
                assert.equal(i.response.addProviderHost.args[1][1], 'cn.bar.net', 'Verifying Provider CNAME 2');
                assert.equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    QUnit.test('geo_override_on_country data problem fallback behaviour RR', function(assert) {
        test_handle_request({
            ...
            verify: function(i) {
                ...
                assert.equal(i.response.addProviderHost.args[0][1], 'cn.bar.net', 'Verifying Provider CNAME 1');
                assert.equal(i.response.addProviderHost.args[1][0], 'foo', 'Verifying Provider Alias 2');
                assert.equal(i.response.addProviderHost.args[1][1], 'az.foo.net', 'Verifying Provider CNAME 2');
                assert.equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
