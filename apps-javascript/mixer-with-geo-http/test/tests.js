...
(function() {
    ...
    test('test 1 optimum_server_chosen', test_handle_request({
        ...
        verify: function(i) {
            ...
            equal(i.response.addProviderHost.callCount, 2, 'Verifying addProviderHost call count');
            equal(i.response.setReasonCode.callCount, 1, 'Verifying setReasonCode call count');

            equal(i.response.addProviderHost.args[0][0], 'bar', 'Verifying Provider Alias 1');
            equal(i.response.addProviderHost.args[0][1], 'cn.bar.net', 'Verifying Provider CNAME 1');
            equal(i.response.addProviderHost.args[1][0], 'foo', 'Verifying Provider Alias 2');
            equal(i.response.addProviderHost.args[1][1], 'cn.foo.net', 'Verifying Provider CNAME 2');
            equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    test('optimum_server_chosen_No_KBPS', test_handle_request({
        ...
        verify: function(i) {
            ...
            equal(i.response.addProviderHost.args[0][1], 'cn.foo.net', 'Verifying Provider CNAME 1');
            equal(i.response.addProviderHost.args[1][0], 'bar', 'Verifying Provider Alias 2');
            equal(i.response.addProviderHost.args[1][1], 'cn.bar.net', 'Verifying Provider CNAME 2');
            equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
            equal(i.response.setReasonCode.args[0][0], 'I,A', 'Verifying setReasonCode');
        }
    }));
    ...
    test('test 2 geo_override_on_state', test_handle_request({
        ...
        verify: function(i) {
            ...
            equal(i.response.addProviderHost.args[0][0], 'foo', 'Verifying Provider Alias 1');
            equal(i.response.addProviderHost.args[0][1], 'az.foo.net', 'Verifying Provider CNAME 1');
            equal(i.response.addProviderHost.args[1][0], 'baz', 'Verifying Provider Alias 2');
            equal(i.response.addProviderHost.args[1][1], 'az.baz.net', 'Verifying Provider CNAME 2');
            equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    test('test 6 asn_override', test_handle_request({
        ...
        verify: function(i) {
            ...
            equal(i.response.addProviderHost.args[0][1], 'cn.foo.net', 'Verifying Provider CNAME 1');
            equal(i.response.addProviderHost.args[1][0], 'baz', 'Verifying Provider Alias 2');
            equal(i.response.addProviderHost.args[1][1], 'cn.baz.net', 'Verifying Provider CNAME 2');
            equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    test('fallbackBehavior none avail choose highest avail', test_handle_request({
        ...
        verify: function(i) {
            ...
            equal(i.response.addProviderHost.args[0][1], 'cn.baz.net', 'Verifying Provider CNAME 1');
            equal(i.response.addProviderHost.args[1][0], 'bar', 'Verifying Provider Alias 2');
            equal(i.response.addProviderHost.args[1][1], 'cn.bar.net', 'Verifying Provider CNAME 2');
            equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
    ...
    test('geo_override_on_country data problem fallback behaviour RR', test_handle_request({
        ...
        verify: function(i) {
            ...
            equal(i.response.addProviderHost.args[0][1], 'cn.bar.net', 'Verifying Provider CNAME 1');
            equal(i.response.addProviderHost.args[1][0], 'foo', 'Verifying Provider Alias 2');
            equal(i.response.addProviderHost.args[1][1], 'az.foo.net', 'Verifying Provider CNAME 2');
            equal(i.response.setStatus.args[0][0], 200, 'Verifying setStatus');
