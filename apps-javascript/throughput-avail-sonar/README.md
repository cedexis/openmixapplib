# Application: **Sonar and Radar availability with Radar KBPS**

This application uses sonar and radar availability to filter the platform, then it chooses the Highest Kbps platform.
