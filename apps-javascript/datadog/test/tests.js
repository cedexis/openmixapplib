            ...
            i.request
                ...
                .returns({
                    "foo": JSON.stringify({
                        ...
                        "monitor_id": "3617169",
                        "status": "OK",
                        "title": "[Recovered on {host:gw.ops,instance:fusiondemo,url:https://gprvfpe43d.execute-api.eu-west-1.amazonaws.com/prod/datadogfusiondemo}] FusionDemo Alert"
                    }),
                    "bar": JSON.stringify({
                        "date": "1515016903000",
                        "event_id": "4206954649828087263",
            ...
            i.request
                ...
                .returns({
                    "foo": JSON.stringify({
                        ...
                        "monitor_id": "3617169",
                        "status": "Alert",
                        "title": "[Triggered on {host:gw.ops,instance:fusiondemo,url:https://gprvfpe43d.execute-api.eu-west-1.amazonaws.com/prod/datadogfusiondemo}] FusionDemo Alert"
                    }),
                    "bar": JSON.stringify({
                        "date": "1515016903000",
                        "event_id": "4206954649828087263",
