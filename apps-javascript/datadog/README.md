# Application: **Datadog Alert using Fusion**

Uses a Datadog Alert Fusion feed that provides health data along with RTT for selecting among healthy servers. Demonstrates how to input a Datadog Alert feed into Openmix applications and use that data in the decision making process.
