...
class OpenmixApplicationTests extends PHPUnit_Framework_TestCase
{
    ...
    public function init()
    {
        ...
        foreach ($test_data as $i) {
            ...
            $config->expects($this->at($call_index++))
                ->method('declareInput')
                ->with('real:fusion:mbps', $i['fusion_aliases']);
    ...
    public function service()
    {
        $test_data = array(
            array(
                'description' => 'all below mbps threshold; all available; provider "a" fastest',
                'providers' => array(
                    'a' => array('cname' => 'a.foo.com', 'padding' => 0),
                    'b' => array('cname' => 'b.foo.com', 'padding' => 0),
                    'c' => array('cname' => 'c.foo.com', 'padding' => 0),
                ...
                'burstable_cdns' => array(
                    'a' => array('threshold' => 100, 'multiplier' => 1.5),
                    'b' => array('threshold' => 100, 'multiplier' => 1.5)
                ),
                'availability_threshold' => 90,
                'calls' => array(
                    array(
                        'mbps' => array( 'a' => 90, 'b' => 90 ),
            ...
            array(
                'description' => 'all below mbps threshold; none available; provider "a" least unavailable',
                'providers' => array(
                    'a' => array('cname' => 'a.foo.com', 'padding' => 0),
                    'b' => array('cname' => 'b.foo.com', 'padding' => 0),
                    'c' => array('cname' => 'c.foo.com', 'padding' => 0),
            ...
            array(
                'description' => 'all available; "a" fastest but above mbps threshold; "b" fastest after padding adding',
                'providers' => array(
                    'a' => array('cname' => 'a.foo.com', 'padding' => 0),
                    'b' => array('cname' => 'b.foo.com', 'padding' => 0),
                    'c' => array('cname' => 'c.foo.com', 'padding' => 0),
                ...
                'calls' => array(
                    array(
                        'mbps' => array( 'a' => 110, 'b' => 90 ),
                        'rtt' => array( 'a' => 100, 'b' => 150, 'c' => 200 ),
                        'avail' => array( 'a' => 100, 'b' => 100, 'c' => 100 ),
                        'alias' => 'b',
                        'reason' => 'A',
                    ),
            ...
            array(
                'description' => 'call #1 "b" is over mbps threshold, call #2 "a" is over mbps threshold; "c" is fastest',
                'providers' => array(
                    'a' => array('cname' => 'a.foo.com', 'padding' => 0),
                    'b' => array('cname' => 'b.foo.com', 'padding' => 0),
                    'c' => array('cname' => 'c.foo.com', 'padding' => 0),
                ...
                'calls' => array(
                    array(
                        'mbps' => array( 'a' => 0, 'b' => 110 ),
                        'rtt' => array( 'a' => 200, 'b' => 100, 'c' => 150 ),
                        'avail' => array( 'a' => 100, 'b' => 100, 'c' => 100 ),
                        'alias' => 'c',
                        'reason' => 'A',
                    ),
                    array(
                        'mbps' => array( 'a' => 110, 'b' => 0 ),
            ...
            array(
                'description' => 'missing mbps data; "b" is fastest',
                'providers' => array(
                    'a' => array('cname' => 'a.foo.com', 'padding' => 0),
                    'b' => array('cname' => 'b.foo.com', 'padding' => 0),
                    'c' => array('cname' => 'c.foo.com', 'padding' => 0),
            ...
            array(
                'description' => 'all below mbps threshold; all available; provider "a" fastest; "b" non-score filtered out',
                'providers' => array(
                    'a' => array('cname' => 'a.foo.com', 'padding' => 0),
                    'b' => array('cname' => 'b.foo.com', 'padding' => 0),
                    'c' => array('cname' => 'c.foo.com', 'padding' => 0),
        ...
        foreach ($test_data as $i) {
            ...
            foreach ($i['calls'] as $j) {
                ...
                $request->expects($this->at($call_index++))
                    ->method('fusion')
                    ->with('real:fusion:mbps')
                    ->will($this->returnValue($j['mbps']));
